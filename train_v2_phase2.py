...
val_loader = DataLoader(val_dataset, batch_size=256, shuffle=False, num_workers=4, pin_memory=True, drop_last=True)
...
checkpoint_manager = CheckpointManager(save_dir='/root/Project/brick_vidgen/vnclip/checkpoints_v3_160326_phase2', max_checkpoints=10)
start_epoch = 1  # Default start epoch if no checkpoint is found
try:
    ckpt_path = "/root/Project/brick_vidgen/vnclip/checkpoints_v3_160326/checkpoint_epoch_17_2026-03-17.pth"
